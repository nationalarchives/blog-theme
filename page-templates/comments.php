...
<?php if ( have_comments() ) : ?>
			...
			<h3><?php
			printf( _n( '1 comment', '%1$s comments', get_comments_number(), 'starkers' ),
...
<div class="disclaimer"><span>We will not be able to respond to personal family history research questions on the blog.</span> See our <a href="/moderation-policy">moderation policy</a> for more details.
</div>
</div>
