...
<div class="container row banner-seperator">
  <div class="col starts-at-full ends-at-full box clr">
    <div class="filter clr">
      ...
      <a href="/blogposts" class="call-to-action-link right">List view</a>
    </div>
    ...
    <div class="breather">
      <div class="row">
        ...
        <div class="col starts-at-full ends-at-one-third clr blog-latest-large">
          <h3><a href="<?php the_permalink(); ?>"><?php echo wp_trim_words( get_the_title(), 9 ); ?></a></h3>
          <?php if (has_post_thumbnail( $post->ID ) ): ?>
          <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' ); ?>
          <span class="blog-img"><img style="width: 100%; height: 10em;" src="<?php echo $image[0]; ?>" alt="" /></span>
          <?php endif; ?>
      ...
      <div class="row">
        <div id="categoryTabs">
          <ul id="records-research">
            ...
            <div class="col starts-at-full ends-at-one-third clr blog-latest"> <a href="<?php the_permalink(); ?>">
