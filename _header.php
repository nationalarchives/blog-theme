...
<link rel="stylesheet" type="text/css" media="all" href="http://nationalarchives.gov.uk/styles/media-queries.css" />
...
<!--[if IE 7]>
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/styles/ie7.css">
<![endif]-->
<!--[if IE 8]>
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/styles/ie8.css">
<![endif]-->
<!--[if IE 9]>
...
<!--[if (gte IE 6)&(lte IE 8)]>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/styles/ie-7-and-8.css">
<![endif]-->
...
<div id="page-header" role="banner">
  ...
  <noscript>
  <div id="mega-menu" style="display: block;" role="navigation">
  ...
  <nav class="col mega-menu-group clr">
    <div>
      ...
      <ul>  
        ...
        <li><a href="http://nationalarchives.gov.uk/records/our-online-/records" onclick="dcsMultiTrack('DCS.dcsuri','/menu/Our online records ','WT.ti','Menu - Our online records ');">Our online records</a></li>
...
<div class="container row">
  <div class="header-blog clr">
    <h1><span><span><a href="/" title="The National Archives blog" rel="home">Blog</a></span></span></h1>
  </div>
  <div id="blog-tools" class="blog-tools-content clr">
